        ...
        mDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
               ...
               // String image = dataSnapshot.child("thumb_image").getValue().toString();
                ...
                StorageReference ref = FirebaseStorage.getInstance().getReference().child("profiles/" + from_user_id);
                ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    @Override
                    public void onSuccess(final Uri uri) {
                        Picasso.with(holder.profileImage.getContext()).load(uri.toString()).
                                placeholder(R.drawable.ic_account_box_black_24dp).into(holder.profileImage);
